...
.controller('HomeCtrl', function($scope, $rootScope, $http, $timeout, $ionicPlatform, errorInterceptor, serializeData, $ionicSideMenuDelegate, $ionicLoading, autoLogin, BureoApiUrl) {
