...
.controller('MyPartiesCtrl', function($scope, $rootScope, $http, $ionicLoading, autoLogin, BureoApiUrl) {
   ...
   */
.controller('MyPartyAttendanceCtrl', function($scope, $rootScope, $http, $stateParams, $ionicLoading, $ionicModal, autoLogin, BureoApiUrl) {
