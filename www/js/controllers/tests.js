...
.controller('TestsCtrl', function($scope, $rootScope, $http, $state, $cordovaImagePicker, BureoApiUrl, serializeData, $ionicSideMenuDelegate, $ionicLoading, $cordovaFile, $cordovaFileTransfer) {
