...
angular.module('bureo', ['ionic', 'ionicLazyLoad', 'ngCordova', 'bureo.controllers', 'bureo.services', 'bureo.directives', 'ionic-numberpicker', 'ionic-timepicker', 'ionicLazyLoad', 'ion-gallery'])
/** LOCALHOST **/
...
ionic run android
*/
// .constant('BureoApiUrl', 'http://192.168.1.57/bureo/frontend/web')
...
.config(function($stateProvider, $urlRouterProvider, $ionicConfigProvider, $httpProvider) {
  ...
  /**
   * Interceptor para detectar y gestionar errores surgidos al conectar con el backend 
   */
  ...
  //         ionicPopup.alert({
  //           title: '<span class="assertive"><strong>Error ' + response.status +'</strong> </span>',
  //           template: '<span class="assertive"><strong>Error de conexión</strong></span>'
  //         });
  //       }
  //       else{
  //         ionicPopup.alert({
  //           title: '<span class="assertive"><strong>Error ' + response.status +'</strong></span>',
  //           template: angular.toJson(response.data),
  //         });
  //       }
